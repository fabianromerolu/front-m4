...
const Footer = () => {
  return (
    <footer className="w-full bg-[var(--color-morado)] text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="flex flex-col items-center md:items-start">
            ...
            <p className="text-sm text-center md:text-left mb-6 text-white/90">
              Tu destino para productos exclusivos y de calidad. Dexter Store 2025.
            </p>
          ...
          <div className="flex flex-col items-center md:items-start">
            ...
            <ul className="space-y-3 text-center md:text-left">
              ...
              <li className="flex items-center justify-center md:justify-start gap-2">
                ...
                <span className="text-white/90">Montería, Córdoba, Col</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row justify-center items-center gap-4">
          <p className="text-sm text-white/90">
            © 2025 Dexter Store. Todos los derechos reservados.
          </p>
        </div>
      </div>
    </footer>
